...
async def latest_logistic_message(call: types.CallbackQuery):
    await call.answer(
...
@dp.callback_query_handler(F.data.contains('avia_'), state='*')
async def get_avia_uz(call: types.CallbackQuery):
    ...
    await latest_logistic_message(call=call)


@dp.callback_query_handler(F.data.contains('auto_'), state='*')
async def get_auto_uz(call: types.CallbackQuery):
    album = types.MediaGroup()
    telegram_id = call.from_user.id
    region = call.data.split('_')[1]
    id_ = call.data.split('_')[2]
...
@dp.callback_query_handler(F.data.contains('railway_'), state='*')
async def get_railway_uz(call: types.CallbackQuery):
    album = types.MediaGroup()
    telegram_id = call.from_user.id
    region = call.data.split('_')[1]
    id_ = call.data.split('_')[2]
...
@dp.callback_query_handler(F.data.contains('multimodal_'), state='*')
async def get_multimodal_uz(call: types.CallbackQuery):
    album = types.MediaGroup()
    telegram_id = call.from_user.id
    region = call.data.split('_')[1]
    id_ = call.data.split('_')[2]
